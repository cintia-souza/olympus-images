    ...
    <main className="flex flex-col items-center justify-center min-h-screen px-4">
      <div className="text-center max-w-2xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-10">
          <Feature icon={<Sparkles className="text-accent" />} title="Prompts Inteligentes" desc="Formulário guiado para criar prompts perfeitos" />
          <Feature icon={<Zap className="text-accent" />} title="Geração Rápida" desc="Stable Diffusion XL via Hugging Face" />
          <Feature icon={<ImageIcon className="text-accent" />} title="Alta Qualidade" desc="Imagens em alta resolução para download" />
        </div>
